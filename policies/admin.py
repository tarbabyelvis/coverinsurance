...
from policies.models import Beneficiary, Dependant, Policy, PolicyPaymentSchedule, PremiumPayment


@admin.register(Policy)
class PolicyAdmin(admin.ModelAdmin):
    list_display = ['client', 'commencement_date', 'expiry_date', 'policy_terms', 'policy_number', 'insurer' ]
