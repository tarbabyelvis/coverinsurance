...
POLICY_COLUMNS_BORDREX = {
    ...
    # dump file columns are the following
    # "policy_number": "LoanRefId",
    # "client_id": "ClientRefId",
    # "merchant": "Merchant",
    # "province": "Provinsie",
    # "risk_identifier": "RiskBand",
    # "sum_insured": "Loan Amount",
    # "interest_rate": "Int Rate %",
    # "initiation_fee": "InitiationFee",
    # "service_fee": "ServiceFee",
    # "policy_term": "Loan Term",
    # "approval_date": "Disbursement Date",
    ...
    # "expiry_date": "CloseDate",
    # "agency": "Agency",
    # "remaining_terms": "Remaining Term",
    # "account_balance_active": "Account Balance Active and Charge Off",
    # "account_balance_current_month": "Account Balance Active Book Current Month",
    # "account_balance_active_prior_month": "Account Balance Active Book Prior Month",
    # "llp_current_month": "LLP Current Month",
    # "llp_prior_month": "LLP Prior Month",
    # "arrears_current_month": "Arrears Cu Month",
    # "total_extracted_installment": "Total extracted installment",
    # "total_schedule_insta": "Total Schedule Insta",
    # "cli_inv_month": "CLI Inv Mnth (C5)",
    # "last_payment_amount": "Last Payment Amount",
    # "pd_month": "Pd Mnth",
    # "pd_month_t1": "Pd Mnth (T-1)",
    # "pd_month_t2": "Pd Mnth (T-2)",
    # "pd_month_t3": "Pd Mnth (T-3)",
    # "pd_month_t4": "Pd Mnth (T-4)",
    # "pd_month_t5": "Pd Mnth (T-5)",
    # "pd_month_t6": "Pd Mnth (T-6)",
    # "pd_month_t7": "Pd Mnth (T-7)",
    # "pd_month_t8": "Pd Mnth (T-8)",
    # "pd_month_t9": "Pd Mnth (T-9)",
    # "pd_month_t10": "Pd Mnth (T-10)",
    # "pd_month_t11": "Pd Mnth (T-11)",
    # "pd_month_t12": "Pd Mnth (T-12)",
    # "total_pd": "Total Pd",
    # "gross_salary": "GrossSalary",
    # "basic_salary": "BasicSalary",
    # "monthly_fee": "Monthly Fee (incl VAT)",
    # "interest": "Interest",
    # "total_interest": "Total Interest",
    # "overdue_interest": "OverdueInterest",
    # "initiation_fee_month": "Initation Fee Month (incl VAT)",
    # "cli_sched": "CLI Sched",
    # "cli_monthly_premium": "Monthly CLI Prem",
...
POLICY_COLUMNS_INDLU = {
    ...
    "payment_method": "PaymentMethod",
    "expiry_date": "CloseDate",
    "total_premium": "LoanAmount",
    "json_debt_book": "DebtBook",
    "json_merchant": "Merchant",
    "json_province": "Province",
    "json_approval_date": "ApprovalDate",
    "json_credit_score": "ApplicationCreditScore",
    "json_service_fee": "ServiceFee",
    "json_initiation_fee": "InitiationFee",
    "json_interest_rate": "InterestRate",
...
POLICY_CLIENT_COLUMNS_INDLU = {
    ...
    "payment_method": "PaymentMethod",
    "expiry_date": "CloseDate",
    "json_special_circumstances": "Special Circumstances",
    "json_debt_book": "DEBT BOOK",
    "json_merchant": "Merchant",
    "json_credit_score": "Application Score",
    "json_client_id": "ClientRefId",
    # "json_death_original_sum_assured": "Death Original Sum Assured",
    ...
    "json_account_balance_active": "Account Balance Active and Charge Off",
    "json_account_balance_current_month": "Account Balance Active Book Current Month",
    "json_account_balance_active_prior_month": "Account Balance Active Book Prior Month",
    "json_llp_current_month": "LLP Current Month",
    "json_llp_prior_month": "LLP Prior Month",
    "json_arrears_current_month": "Arrears Cu Month",
    "json_total_extracted_installment": "Total extracted installment",
    "json_total_schedule_insta": "Total Schedule Insta",
    "json_cli_inv_month": "CLI Inv Mnth (C5)",
    "json_last_payment_amount": "Last Payment Amount",
    "json_pd_month": "Pd Mnth",
    "json_pd_month_t1": "Pd Mnth (T-1)",
    "json_pd_month_t2": "Pd Mnth (T-2)",
    "json_pd_month_t3": "Pd Mnth (T-3)",
    "json_pd_month_t4": "Pd Mnth (T-4)",
    "json_pd_month_t5": "Pd Mnth (T-5)",
    "json_pd_month_t6": "Pd Mnth (T-6)",
    "json_pd_month_t7": "Pd Mnth (T-7)",
    "json_pd_month_t8": "Pd Mnth (T-8)",
    "json_pd_month_t9": "Pd Mnth (T-9)",
    "json_pd_month_t10": "Pd Mnth (T-10)",
    "json_pd_month_t11": "Pd Mnth (T-11)",
    "json_pd_month_t12": "Pd Mnth (T-12)",
    "json_total_pd": "Total Pd",
    "json_remaining_term": "Remaining Term",
    "json_monthly_fee": "Monthly Fee (incl VAT)",
    "json_interest": "Interest",
    "json_total_interest": "Total Interest",
    "json_overdue_interest": "OverdueInterest",
    "json_initiation_fee_month": "Initation Fee Month (incl VAT)",
    "json_cli_sched": "CLI Sched",
    "json_cli_monthly_premium": "Monthly CLI Prem",
    # "json_total_premium": "Prem",
    # "json_net_premium_paid_including_admin": "Net premium paid over to GR including GR admin fee",
    # "json_current_loan_balance": "Current outstanding balance",
    # "json_instalment_amount": "Instalment amount",
    "sector": "Sector",
    "job_description": "Job Description",
    "client_json_last_payment_date": "Last Payment Date",
    "gender": "Gender",
    "employer": "Employer",
...
REPAYMENT_COLUMNS_INDLU = {
    ...
    "into_cash_draw": "Into Cash Draw",
    "out_of_cash_draw": "Out Of Cash Draw",
